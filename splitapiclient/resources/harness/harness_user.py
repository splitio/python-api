...
class HarnessUser(BaseResource):
    '''
    HarnessUser resource representing a Harness user
    '''
    _schema = {
        "name": "string",
        "email": "string",
    ...
    def __init__(self, data=None, client=None):
        '''
        Initialize a HarnessUser resource
        ...
        BaseResource.__init__(self, data.get('uuid'), client)
